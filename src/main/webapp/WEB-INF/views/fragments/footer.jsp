...
<footer>
    <div class="contact">
        ...
        <form class="form--contact" method="post" action="<c:url value="/contactForm"/>">
            <div class="form-group form-group--50"><input type="text" name="name" placeholder="Imię i nazwisko"/></div>
